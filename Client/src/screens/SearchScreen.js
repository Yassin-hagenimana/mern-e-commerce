  ...
  return (
    ...
    <h3>Departments</h3>
     ...
     className={'all'===category ? 'text-bold':''}
      to={getFilterUlr({category: 'all' })}>
     Any
     </Link>
     </li>
     {categories.map((c)=>(
         <li key={c}>
         <Link className={c===category? 'text-bold':""} to={getFilterUlr({category:c})}>
         {c}
         </Link>
     ...
     <ul>
     <li>
     <Link className={'all'===price? 'text-bold':""} to={getFilterUlr({price:'all'})}>
     Any
     </Link>
     </li>
     {prices.map((p)=>(
         <li key={p.value}>
         <Link className={p.value===price?'text-bold':""} to={getFilterUlr({price:p.value})}>
         {p.name}
         </Link>
         </li>
     ))}
